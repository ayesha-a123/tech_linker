      ...
      drawer: Drawer(
        ...
        child: ListView(
          children: [
            ...
            Column(
              children: [
                CustomListTiles(icon: Icons.dashboard, title: 'Dashboard', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AdminDashboard()))),
                CustomListTiles(icon: Icons.work_outline, title: 'Manage Internships', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => Manageinterships()))),
                CustomListTiles(icon: Icons.school, title: 'Manage Students', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ManageStudentsScreen()))),
                CustomListTiles(icon: Icons.apartment, title: 'ManageInstitutes', onTap: ()  {Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Manageinstitute()));}),
                CustomListTiles(icon: Icons.bar_chart, title: 'AnalyticsAndReports', onTap: () {}),
                CustomListTiles(icon: Icons.settings, title: 'Settings', onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AdminSettingsScreen()));}),
                CustomListTiles(icon: Icons.support_agent, title: 'SupportAndFeedback', onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (context)=>SupportAndFeedbackScreen()));}),
                CustomListTiles(icon: Icons.info_outline, title: 'AboutUs', onTap: () {}),
                CustomListTiles(icon: Icons.logout, title: 'SignOut', onTap: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) =>  SigninScreen()))),
              ],
            )
          ],
        ),
